        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 border-right d-flex flex-column">
                    <div class="media flex-column mt-3">
                        <a class="d-flex align-self-start">
                          <img src="{{asset('userimages/'.auth()->user()->user_image)}}" class="user-img" alt="">
                      </a>
                    ...
                    <div class="d-flex driver-info flex-column">
                        <div class="info d-flex flex-wrap pt-3">
                            ...
                            <div class="info-item">
                                ...
                                <p>{{auth()->user()->car_model}}</p>
                            </div>
                            <div class="info-item">
                                <i class="fas fa-car"></i>
                                <p>{{auth()->user()->car_number}}</p>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <p>{{auth()->user()->location}}, Egypt</p>
                            </div>
                    </div>
                        <div class="contacts d-flex flex-column pt-3">
                            <div class="info-item">
                                <i class="fas fa-phone"></i>
                                <p class="m-0">{{auth()->user()->mobile_number}}</p>
                            </div>
                            <div class="info-item">
               ...
               <!-- price list -->
                ...
                <div class="carimage">
                    <h4>Car Image<h4>
                    <img  src="{{asset('carimages/'.auth()->user()->car_image)}}" class="car-img" alt="">
                </div>
